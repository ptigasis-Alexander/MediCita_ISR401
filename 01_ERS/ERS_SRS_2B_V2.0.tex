...
\begin{document}
	...
	\subsection{Matriz de trazabilidad extendida}
			...
			La matriz canónica de cierre contiene 70 filas: una fila por cada uno de los 40 RF, una fila individual por cada uno de los 17 RNF activos (RNF-01 a RNF-16 y RNF-18), y filas adicionales que registran relaciones RF-caso de uso adicionales identificadas durante la segunda ronda de elicitación. Cada celda \texttt{ID-RF/RNF} contiene un único identificador; se eliminaron identificadores compuestos que impedían el contraste automático. Cuando un RNF es transversal y no posee CU, HU o mockup propio, se declara explícitamente \textit{No aplica} en lugar de inventar una asociación.
