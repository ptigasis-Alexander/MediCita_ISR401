...
\begin{document}
	...
	\begin{titlepage}
		...
		{\large Versión 2.0 --- Entrega 4 (2B / Defensa Final) --- Línea base documental final}\\[0.2cm]
		...
		Último commit hasta el Miercoles 02/09/2026 con 23:55 horas
	...
	\begin{quote}
		\textbf{Pendiente para el equipo:} este RNF-20 define el requisito, los indicadores y su umbral; el monitoreo real solo puede ejecutarse una vez el asistente esté desplegado en producción, lo cual está fuera del alcance de este corte del PFC.
	\end{quote}
