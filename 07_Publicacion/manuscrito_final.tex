...
\begin{document}
	...
	\subsection{Confiabilidad del análisis y validación con los participantes}
	Con posterioridad al corte inicial del análisis, se ejecutaron dos controles de calidad adicionales sobre el componente cualitativo. Primero, se calculó el acuerdo intercodificador (kappa de Cohen) entre dos integrantes del equipo que codificaron de forma independiente, sin consultarse entre sí, un subconjunto de 38 segmentos extraídos de 2 de las 8 transcripciones de elicitación (25\,\% del corpus), utilizando el mismo catálogo de 14 categorías temáticas ya validado en la primera ronda de codificación. El cálculo, realizado mediante un script reproducible, arrojó $\kappa=0{,}6997$ (intervalo de confianza 95\,\%: $[0{,}5255,\ 0{,}8739]$), interpretado como un acuerdo sustancial según la escala de Landis y Koch (1977).
	
	Segundo, se realizó una sesión formal de miembro-verificación (\emph{member checking}) el 04/09/2026, de forma presencial, con tres participantes previos del estudio (personal de Medicina General, Enfermería, y Recepción/Recaudación), quienes revisaron la interpretación del equipo sobre los siete bloques temáticos del análisis cualitativo. El resultado fue una confirmación general con matices: dos bloques (historia clínica y seguimiento; reportes y transformación digital) fueron confirmados sin observaciones, y los cinco restantes fueron confirmados con matices puntuales sobre claridad de agenda y disponibilidad, legibilidad de la interfaz, permisos por rol, y responsabilidades del flujo de medicamentos. No se registraron discrepancias que contradijeran la interpretación central del equipo investigador. El consentimiento de participación fue verbal, otorgado en el momento; no se realizó grabación de la sesión, hecho declarado explícitamente en el acta correspondiente.
	...
	\textbf{Confiabilidad:} la ficha de observación y los scripts permiten reproducir conteos y el resultado de la prueba de permutación de forma determinista (semilla fija). El acuerdo intercodificador (kappa de Cohen $=0{,}6997$, sustancial) y la sesión de member checking, reportados en la Sección~6.4, se ejecutaron sobre un subconjunto del corpus (25\,\% de las transcripciones y tres participantes, respectivamente), por lo que refuerzan mas no sustituyen la necesidad de una validación con muestra completa en trabajo futuro.
	...
	Como trabajo futuro se identifica una línea concreta: cerrar RF-09 y RF-18 en una nueva iteración del MVP y repetir la verificación técnica reproducible sobre la versión resultante. El acuerdo intercodificador y la sesión de member checking, inicialmente proyectados como trabajo futuro, se ejecutaron durante el cierre de esta entrega y se reportan en la Sección~6.4; una línea complementaria pendiente es extender ambos controles a una muestra mayor (codificación de la totalidad del corpus y member checking con un número más amplio de participantes) en una eventual continuación del proyecto.
