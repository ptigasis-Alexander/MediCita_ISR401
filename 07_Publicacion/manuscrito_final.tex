...
\begin{document}
	...
	Los artefactos analíticos se organizan en \texttt{06\_Experimento} y el conjunto destinado a publicación en \texttt{07\_Publicacion/dataset\_zenodo}. El depósito abierto incluye únicamente datos derivados y seudonimizados necesarios para reproducir los conteos, la prueba de permutación y la cobertura técnica. El DOI de Zenodo se incorporará únicamente después de realizar el depósito real. El registro OSF (DOI: 10.17605/OSF.IO/DTYNC) documenta el protocolo; las desviaciones de ejecución se documentan por separado en \texttt{osf\_deviations.pdf}. La evidencia identificable permanece restringida.
